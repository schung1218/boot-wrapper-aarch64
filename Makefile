...
pkgdatadir = $(datadir)/boot-wrapper
pkgincludedir = $(includedir)/boot-wrapper
pkglibdir = $(libdir)/boot-wrapper
pkglibexecdir = $(libexecdir)/boot-wrapper
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
#am__append_1 = -DKERNEL_32
#am__append_2 = -DBOOTWRAPPER_32
#am__append_3 = -marm -mno-unaligned-access
am__append_4 = -mgeneral-regs-only -mstrict-align
#am__append_5 = psci.o
#am__append_6 = -DGIC_DIST_BASE=$(GIC_DIST_BASE) \
#	-DGIC_RDIST_BASE=$(GIC_RDIST_BASE)
am__append_7 = -DGIC_CPU_BASE=$(GIC_CPU_BASE) \
	-DGIC_DIST_BASE=$(GIC_DIST_BASE)
subdir = .
...
ACLOCAL = ${SHELL} /home/schung/Git_Server/nua3500/boot-wrapper-aarch64/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/schung/Git_Server/nua3500/boot-wrapper-aarch64/missing autoconf
AUTOHEADER = ${SHELL} /home/schung/Git_Server/nua3500/boot-wrapper-aarch64/missing autoheader
AUTOMAKE = ${SHELL} /home/schung/Git_Server/nua3500/boot-wrapper-aarch64/missing automake-1.15
AWK = gawk
...
CFLAGS = -g -O2 $(am__append_3) $(am__append_4) \
	-I$(top_srcdir)/include/ -I$(top_srcdir)/$(ARCH_SRC)/include/ \
	-Wall -fomit-frame-pointer -ffunction-sections -fdata-sections
CMDLINE = root=/dev/ram0 console=ttyS0,9600n8 rdinit=/linuxrc mem=128M
CPP = aarch64-linux-gnu-gcc -E
CPPFLAGS =  $(am__append_2) $(INITRD_FLAGS)
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"boot-wrapper\" -DPACKAGE_TARNAME=\"boot-wrapper\" -DPACKAGE_VERSION=\"v0.2\" -DPACKAGE_STRING=\"boot-wrapper\ v0.2\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"boot-wrapper\" -DVERSION=\"v0.2\"
DEPDIR = .deps
DTC = /usr/bin/dtc
ECHO_C = 
ECHO_N = -n
...
KERNEL_32 = 
KERNEL_DTB = /home/schung/work/ma35d1/git-source/linux-5.4.y/arch/arm64/boot/dts/nuvoton/nua3500-evb.dtb
KERNEL_IMAGE = /home/schung/work/ma35d1/git-source/linux-5.4.y/arch/arm64/boot/Image
KERN_DIR = /home/schung/Git_Server/nua3500/linux-4.14.y
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/schung/Git_Server/nua3500/boot-wrapper-aarch64/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = boot-wrapper
PACKAGE_BUGREPORT = 
PACKAGE_NAME = boot-wrapper
PACKAGE_STRING = boot-wrapper v0.2
PACKAGE_TARNAME = boot-wrapper
PACKAGE_URL = 
...
VERSION = v0.2
XEN_CMDLINE = console=dtuart dtuart=serial0 no-bootscrub
XEN_IMAGE = 
abs_builddir = /home/schung/Git_Server/nua3500/boot-wrapper-aarch64
abs_srcdir = /home/schung/Git_Server/nua3500/boot-wrapper-aarch64
abs_top_builddir = /home/schung/Git_Server/nua3500/boot-wrapper-aarch64
abs_top_srcdir = /home/schung/Git_Server/nua3500/boot-wrapper-aarch64
ac_ct_CC = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/schung/Git_Server/nua3500/boot-wrapper-aarch64/install-sh
...
DEFINES = -DCNTFRQ=$(CNTFRQ) -DCPU_IDS=$(CPU_IDS) -DNR_CPUS=$(NR_CPUS) \
	-DSYSREGS_BASE=$(SYSREGS_BASE) -DUART_BASE=$(UART_BASE) \
	-DSTACK_SIZE=256 $(am__append_1) $(am__append_6) \
	$(am__append_7)
PSCI_CPU_ON := 0xc4000003
#PSCI_CPU_ON := 0x84000003
PSCI_CPU_OFF := 0x84000002
OFILES = $(am__append_5) boot_common.o bakery_lock.o platform.o $(GIC) \
	cache.o lib.o $(addprefix $(ARCH_SRC),boot.o stack.o \
	$(BOOTMETHOD) utils.o)
...
GIC_DIST_BASE := $(shell perl -I $(top_srcdir) $(top_srcdir)/findbase.pl $(KERNEL_DTB) 0 'arm,gic-400')
...
GIC := gic.o
#GIC := gic-v3.o
GIC_CPU_BASE := $(shell perl -I $(top_srcdir) $(top_srcdir)/findbase.pl $(KERNEL_DTB) 1 'arm,gic-400')
MBOX_OFFSET := 0xfff8
#MBOX_OFFSET := 0x7ff8
...
$(IMAGE): $(OFILES) model.lds fdt.dtb $(KERNEL_IMAGE) $(FILESYSTEM) $(XEN_IMAGE)
	...
	aarch64-linux-gnu-objcopy -O binary $(IMAGE) linux-system.bin
